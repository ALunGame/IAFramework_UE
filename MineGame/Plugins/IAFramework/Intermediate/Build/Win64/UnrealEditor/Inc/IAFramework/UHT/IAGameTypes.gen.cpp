...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_IAFramework_EUIPanelType_Statics::Enumerators[] = {
		...
		{ "EUIPanelType::Setting", (int64)EUIPanelType::Setting },
		{ "EUIPanelType::Record", (int64)EUIPanelType::Record },
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_IAFramework_EUIPanelType_Statics::Enum_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/Game/IAGameTypes.h" },
		{ "Record.DisplayName", "\xe6\xb8\xb8\xe6\x88\x8f\xe5\xad\x98\xe6\xa1\xa3" },
		{ "Record.Name", "EUIPanelType::Record" },
		{ "Setting.DisplayName", "\xe6\xb8\xb8\xe6\x88\x8f\xe8\xae\xbe\xe7\xbd\xae" },
		{ "Setting.Name", "EUIPanelType::Setting" },
...
template<> IAFRAMEWORK_API UScriptStruct* StaticStruct<FUIPanelConfig>()
{
	...
	struct Z_CompiledInDeferFile_FID_Project_IAFramework_UE_MineGame_Plugins_IAFramework_Source_IAFramework_Public_Game_IAGameTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Project_IAFramework_UE_MineGame_Plugins_IAFramework_Source_IAFramework_Public_Game_IAGameTypes_h_Statics::EnumInfo[] = {
		...
		{ EUIPanelType_StaticEnum, TEXT("EUIPanelType"), &Z_Registration_Info_UEnum_EUIPanelType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1432966391U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Project_IAFramework_UE_MineGame_Plugins_IAFramework_Source_IAFramework_Public_Game_IAGameTypes_h_Statics::ScriptStructInfo[] = {
		{ FUIPanelConfig::StaticStruct, Z_Construct_UScriptStruct_FUIPanelConfig_Statics::NewStructOps, TEXT("UIPanelConfig"), &Z_Registration_Info_UScriptStruct_UIPanelConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUIPanelConfig), 4281990429U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Project_IAFramework_UE_MineGame_Plugins_IAFramework_Source_IAFramework_Public_Game_IAGameTypes_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Project_IAFramework_UE_MineGame_Plugins_IAFramework_Source_IAFramework_Public_Game_IAGameTypes_h_2589527752(TEXT("/Script/IAFramework"),
		Z_CompiledInDeferFile_FID_Project_IAFramework_UE_MineGame_Plugins_IAFramework_Source_IAFramework_Public_Game_IAGameTypes_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Project_IAFramework_UE_MineGame_Plugins_IAFramework_Source_IAFramework_Public_Game_IAGameTypes_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Project_IAFramework_UE_MineGame_Plugins_IAFramework_Source_IAFramework_Public_Game_IAGameTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Project_IAFramework_UE_MineGame_Plugins_IAFramework_Source_IAFramework_Public_Game_IAGameTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Project_IAFramework_UE_MineGame_Plugins_IAFramework_Source_IAFramework_Public_Game_IAGameTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Project_IAFramework_UE_MineGame_Plugins_IAFramework_Source_IAFramework_Public_Game_IAGameTypes_h_Statics::EnumInfo));
