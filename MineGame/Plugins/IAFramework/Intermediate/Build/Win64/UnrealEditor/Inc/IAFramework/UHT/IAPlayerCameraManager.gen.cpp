...
#include "IAFramework/Public/Object/Player/IAPlayerCameraManager.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeIAPlayerCameraManager() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_APlayerCameraManager();
	IAFRAMEWORK_API UClass* Z_Construct_UClass_AIAPlayerCameraManager();
	IAFRAMEWORK_API UClass* Z_Construct_UClass_AIAPlayerCameraManager_NoRegister();
...
// End Cross Module References
	void AIAPlayerCameraManager::StaticRegisterNativesAIAPlayerCameraManager()
	{
	}
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(AIAPlayerCameraManager);
	UClass* Z_Construct_UClass_AIAPlayerCameraManager_NoRegister()
	{
		return AIAPlayerCameraManager::StaticClass();
	}
	struct Z_Construct_UClass_AIAPlayerCameraManager_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_AIAPlayerCameraManager_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_APlayerCameraManager,
		(UObject* (*)())Z_Construct_UPackage__Script_IAFramework,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AIAPlayerCameraManager_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "Object/Player/IAPlayerCameraManager.h" },
		{ "ModuleRelativePath", "Public/Object/Player/IAPlayerCameraManager.h" },
	};
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_AIAPlayerCameraManager_Statics::NewProp_ModuleType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AIAPlayerCameraManager_Statics::NewProp_ModuleType_MetaData[] = {
		{ "Category", "IA" },
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_AIAPlayerCameraManager_Statics::NewProp_ObjectName = { "ObjectName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AIAPlayerCameraManager, ObjectName), METADATA_PARAMS(Z_Construct_UClass_AIAPlayerCameraManager_Statics::NewProp_ObjectName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AIAPlayerCameraManager_Statics::NewProp_ObjectName_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AIAPlayerCameraManager_Statics::NewProp_ClassName_MetaData[] = {
		{ "Category", "IA" },
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_AIAPlayerCameraManager_Statics::NewProp_ClassName = { "ClassName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AIAPlayerCameraManager, ClassName), METADATA_PARAMS(Z_Construct_UClass_AIAPlayerCameraManager_Statics::NewProp_ClassName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AIAPlayerCameraManager_Statics::NewProp_ClassName_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AIAPlayerCameraManager_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AIAPlayerCameraManager_Statics::NewProp_ModuleType_Underlying,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AIAPlayerCameraManager_Statics::NewProp_ModuleType,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AIAPlayerCameraManager_Statics::NewProp_ObjectName,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AIAPlayerCameraManager_Statics::NewProp_ClassName,
	};
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AIAPlayerCameraManager_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UIAOO_NoRegister, (int32)VTABLE_OFFSET(AIAPlayerCameraManager, IIAOO), false },  // 1876789362
		};
	const FCppClassTypeInfoStatic Z_Construct_UClass_AIAPlayerCameraManager_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<AIAPlayerCameraManager>::IsAbstract,
	};
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AIAPlayerCameraManager_Statics::ClassParams = {
		&AIAPlayerCameraManager::StaticClass,
		"Engine",
		&StaticCppClassTypeInfo,
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_AIAPlayerCameraManager_Statics::PropPointers,
		InterfaceParams,
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_AIAPlayerCameraManager_Statics::PropPointers),
		UE_ARRAY_COUNT(InterfaceParams),
		0x009002ACu,
		METADATA_PARAMS(Z_Construct_UClass_AIAPlayerCameraManager_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AIAPlayerCameraManager_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_AIAPlayerCameraManager()
	{
		if (!Z_Registration_Info_UClass_AIAPlayerCameraManager.OuterSingleton)
		{
			UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_AIAPlayerCameraManager.OuterSingleton, Z_Construct_UClass_AIAPlayerCameraManager_Statics::ClassParams);
		}
		return Z_Registration_Info_UClass_AIAPlayerCameraManager.OuterSingleton;
	}
	template<> IAFRAMEWORK_API UClass* StaticClass<AIAPlayerCameraManager>()
	{
		return AIAPlayerCameraManager::StaticClass();
	}
