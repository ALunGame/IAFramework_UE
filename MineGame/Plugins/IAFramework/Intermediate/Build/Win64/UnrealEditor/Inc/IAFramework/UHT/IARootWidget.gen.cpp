...
// End Cross Module References
...
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_LayerCanvas_ValueProp;
		static const UECodeGen_Private::FBytePropertyParams NewProp_LayerCanvas_Key_KeyProp_Underlying;
		static const UECodeGen_Private::FEnumPropertyParams NewProp_LayerCanvas_Key_KeyProp;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_LayerCanvas_MetaData[];
#endif
		static const UECodeGen_Private::FMapPropertyParams NewProp_LayerCanvas;
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UIARootWidget_Statics::NewProp_LayerCanvas_ValueProp = { "LayerCanvas", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 1, Z_Construct_UClass_UCanvasPanel_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UIARootWidget_Statics::NewProp_LayerCanvas_Key_KeyProp_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UIARootWidget_Statics::NewProp_LayerCanvas_Key_KeyProp = { "LayerCanvas_Key", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UEnum_IAFramework_EUILayer, METADATA_PARAMS(nullptr, 0) }; // 4199599475
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UIARootWidget_Statics::NewProp_LayerCanvas_MetaData[] = {
		{ "Comment", "//\xe5\xb1\x82\xe7\xba\xa7""Canvas\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/UI/Panel/IARootWidget.h" },
		{ "ToolTip", "\xe5\xb1\x82\xe7\xba\xa7""Canvas" },
	};
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UIARootWidget_Statics::NewProp_LayerCanvas = { "LayerCanvas", nullptr, (EPropertyFlags)0x0040008000000008, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UIARootWidget, LayerCanvas), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UIARootWidget_Statics::NewProp_LayerCanvas_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UIARootWidget_Statics::NewProp_LayerCanvas_MetaData)) }; // 4199599475
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UIARootWidget_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UIARootWidget_Statics::NewProp_LayerCanvas_ValueProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UIARootWidget_Statics::NewProp_LayerCanvas_Key_KeyProp_Underlying,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UIARootWidget_Statics::NewProp_LayerCanvas_Key_KeyProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UIARootWidget_Statics::NewProp_LayerCanvas,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GitProject_IAFramework_UE_MineGame_Plugins_IAFramework_Source_IAFramework_Public_UI_Panel_IARootWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UIARootWidget, UIARootWidget::StaticClass, TEXT("UIARootWidget"), &Z_Registration_Info_UClass_UIARootWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIARootWidget), 3695550557U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GitProject_IAFramework_UE_MineGame_Plugins_IAFramework_Source_IAFramework_Public_UI_Panel_IARootWidget_h_3382403948(TEXT("/Script/IAFramework"),
